...
export const UserProfile = () => {
  ...
  /* ---------- USER (REDUX) ---------- */
  const userProfile = useSelector((s) =>
    selectUserById(s, userId)
  );
  const profileLoading = useSelector((s) =>
    selectUserIsLoading(s, userId)
  );
  const profileError = useSelector((s) =>
    selectUserError(s, userId)
  );

  console.log(userProfile, profileLoading, profileError)
  ...
  useEffect(() => {
    ...
    const fetchListings = async () => {
      ...
      const data = await res.json();
      if (data.success) setUserListings(data.data);
    };
